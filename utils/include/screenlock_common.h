...
enum ErrorType {
    E_ERRORTYPE_SERVICE_UNAVAILABLE,
    E_ERRORTYPE_SCREENLOCK_FAILED,
    E_ERRORTYPE_UNSCREENLOCK_FAILED,
};

enum ErrorCode {
    //service
    E_ERRORCODE_INIT_FAILED = 1110,
    E_ERRORCODE_TRYTIME_FAILED,
    //runtime
    E_ERRORCODE_UNSCREENLOCK_FAILED = 1117,
    E_ERRORCODE_WAKEUP_FAILED,
    E_ERRORCODE_SCREENON_FAILED,
    E_ERRORCODE_SCREENOFF_FAILED,
    E_ERRORCODE_EXITANIMATION_FAILED,
};
